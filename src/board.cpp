...
Board::Board(std::vector<std::vector<int>> board, bool isWhiteTurn = true, 
                ...
                BoardSquare pawnJumpedSquare = BoardSquare()) {
    this->board = board;
...
std::vector<Board> moveGenerator(Board currBoard) {
    ...
    validPawnMoves(currBoard, listOfMoves);
    validKnightMoves(currBoard, listOfMoves);
    validBishopMoves(currBoard, listOfMoves);
    validRookMoves(currBoard, listOfMoves);
    validQueenMoves(currBoard, listOfMoves);
    validKingMoves(currBoard, listOfMoves);
    return listOfMoves;
}

void validPawnMoves(Board& currBoard, std::vector<Board>& validMoves) {
...
void validKingMoves(Board& currBoard, std::vector<Board>& validMoves) {
