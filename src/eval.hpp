...
constexpr std::array<S, NUM_RANKS> passedPawnTable = {S(0, 0), S(69, 186), S(55, 107), S(20, 63), S(-1, 34), S(-21, 11), S(3, -4), S(0, 0), };
constexpr std::array<S, NUM_PIECES> pieceValsTable = {S(0, 0), S(896, 785), S(333, 271), S(384, 274), S(417, 470), S(69, 90), };
